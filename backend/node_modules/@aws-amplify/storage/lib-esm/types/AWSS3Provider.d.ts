import { GetObjectRequest, GetObjectCommandOutput, PutObjectRequest, CopyObjectRequest, _Object, DeleteObjectCommandOutput, HeadObjectRequest } from '@aws-sdk/client-s3';
...
export declare type S3ProviderGetPropertiesConfig = CommonStorageOptions & {
...
export declare type S3ProviderGetPropertiesOutput = {
    contentType: string;
