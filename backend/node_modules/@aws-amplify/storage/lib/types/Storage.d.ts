 ...
 * config.
 */
declare type StorageOperationConfig<T extends StorageProvider | StorageProviderWithCopy | StorageProviderWithGetProperties, U extends StorageProviderApi> = ReturnType<T['getProviderName']> extends 'AWSS3' ? LastParameter<AWSS3Provider[U]> : T extends StorageProviderWithGetProperties & StorageProviderWithCopy ? LastParameter<T[U]> & {
...
export declare type StorageGetPropertiesConfig<T extends Record<string, any>> = T extends StorageProviderWithGetProperties ? StorageOperationConfig<T, 'getProperties'> : StorageOperationConfigMap<StorageOperationConfig<AWSS3Provider, 'getProperties'>, T>;
...
export declare type StorageGetPropertiesOutput<T> = PickProviderOutput<Promise<S3ProviderGetPropertiesOutput>, T, 'getProperties'>;
/**
