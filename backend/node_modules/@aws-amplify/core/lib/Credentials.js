...
var CredentialsClass = /** @class */ (function () {
    ...
    CredentialsClass.prototype._pickupCredentials = function () {
        ...
        if (!this._gettingCredPromise || !this._gettingCredPromise.isPending()) {
            ...
            this._gettingCredPromise = (0, JS_1.makeQuerablePromise)(this._keepAlive());
        }
        else {
    ...
    CredentialsClass.prototype._providerRefreshWithRetry = function (_a) {
        ...
        return (0, Util_1.jitteredExponentialRetry)(refreshHandler, [], MAX_DELAY_MS)
            .then(function (data) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, (0, CognitoIdentity_1.getId)(cognitoConfig, {
                                    ...
                                    case 1:
                                        ...
                                        _a.label = 2;
                                    case 2: return [4 /*yield*/, (0, CognitoIdentity_1.getCredentialsForIdentity)(cognitoConfig, {
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            guestCredentialsProvider_1 = function () { return __awaiter(_this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0: return [4 /*yield*/, (0, CognitoIdentity_1.getId)(cognitoConfig, {
                                                                IdentityPoolId: identityPoolId,
                                                            })];
                                                        case 1:
                                                            IdentityId = (_a.sent()).IdentityId;
                                                            this._identityId = IdentityId;
                                                            return [4 /*yield*/, (0, CognitoIdentity_1.getCredentialsForIdentity)(cognitoConfig, {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        _c.label = 3;
                    case 3: return [4 /*yield*/, (0, CognitoIdentity_1.getCredentialsForIdentity)(cognitoConfig, {
